      ...
      body: Column(
        children: [
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: 25,top: 50,right: 25,bottom: 20),
              child: Column(
                children: [
                SizedBox(height: 5),
                Stack(
                ...
                Row(
                  children: [
                    Image.asset("images/desticon1.png",height: 30,width: 20,),
                    SizedBox(
                      width: 18,
                    ),
        ...
        (placePredictionsList.length>0 && dropofftextEditingController.text!=null) ?
...
class PredictionTile extends StatelessWidget {
        ...
        child: Column(
            ...
            children: [
              ...
              Expanded(
                  ...
                  children: [
                      Text(placePredictions.main_text??"default", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize:  16),),

                      SizedBox(height: 3,),

                        Text(placePredictions.secondary_text??"default",overflow: TextOverflow.ellipsis, style: TextStyle(fontSize:  12,color: Colors.grey,)),
                  ],
                ),
              ) 
            ],
  ...
  void getPlaceAddressDetails(String placeId, context)async{
    ...
    if(res["status"]=="OK"){
      ...
      Provider.of<AppData>(context,listen: false).updatedropoffLocationAddres(address);
      print("This is Drop off location");
      print("This is Place id"+placeId);
      print("Hello");
